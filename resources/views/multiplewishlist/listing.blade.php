                ...
                <div class="flex flex-col" v-if="wishlists">
                    ...
                    >
                        <a class="flex gap-2 px-2 py-4 w-4/5 text-gray-500" :href="'/account/wishlists/'+wishlist.id">
                            ...
                            <div class="px-4 w-40">@{{ wishlist.items.length }} items</div>
                        ...
                        <div class="flex m-2 gap-2 h-10 self-center justify-end items-center w-1/5">
                            ...
                            <x-rapidez::button variant="outline" v-if="wishlist" @click="removeWishlist(wishlist)">Delete</x-rapidez::button>
                        </div>
                    </div>
                </div>
                <x-rapidez::button variant="outline" class="self-start mt-2" @click="addWishlist('New wishlist')">Create new wishlist</x-rapidez::button>
            </div>
        </wishlist>
    </div>
@endsection