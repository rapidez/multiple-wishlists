<button v-if="window.app.config.globalProperties.loggedIn.value" class="p-3" v-on:click="toggle" aria-label="@lang('Add to wishlist')">
...
<button v-else class="p-3" v-on:click="toggle" aria-label="@lang('Add to wishlist')">
